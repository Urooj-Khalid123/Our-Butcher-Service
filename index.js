...
console.log(chalk.bgGreen.bold(" Cow  "), chalk.bgMagenta.bold(" Goat  "), chalk.bgMagenta.bold(" Camel  "));
const prices = {
    'Eid first day': [
...
async function main() {
    ...
    const selectedService = prices[answers.eidDay].find(service => service.animal === answers.animal);
